...
table_name = 'wildfires.ft_queimada'
geo_col = 'geom_foco'
srid = 4674
...
create_table_query = f'''
        CREATE TABLE IF NOT EXISTS {table_name} (
        	...
        	id_bioma INTEGER,
        	des_satelite VARCHAR,
        	qtd_dias_sem_chuva INTEGER,
        	vl_precipitacao FLOAT8,
        	vl_risco_fogo FLOAT8,
        	vl_frp FLOAT8,
        	{geo_col} GEOMETRY
        );
'''
